...
outpath<-"/tmp"
root<-file.path(.libPaths(), "mergebamsR/extdata/test")
```
...
First, we determined that there are X aligned 
```{r}
bigbam<-"/Users/sfurlan/Desktop/merged_bams/geno_recipient.bam"
cbs<-peekbam(bam)
subsetbam(inputbam = bigbam, outputbams = c("/Users/sfurlan/Desktop/bam1.bam", "/Users/sfurlan/Desktop/bam1.bam"), tags = list(cbs[1:50], cbs[51:100]), cores=2)
