...
t1<-system.time(subsetbam(inputbam = bigbam1, outputbams = c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"), tags = list(mid, ext), cores=2))
file.remove(c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"))
t2<-system.time(subsetbam(inputbam = bigbam1, outputbams = c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"), tags = list(mid, ext), cores=8, split_bam = T))
...
t1<-system.time(subsetbam(inputbam = bigbam1, outputbams = outputnames, tags = tags_little_but_many, cores=8))
file.remove(outputnames)
t2<-system.time(subsetbam(inputbam = bigbam1, outputbams = outputnames, tags = tags_little_but_many, split_bam = T, cores=8))
file.remove(outputnames)
t1
t2
...
any(mid %in% ext)
any(ext %in% mid)
t1<-system.time(subsetbam(inputbam = bigbam2, outputbams = c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"), tags = list(mid, ext), cores=2))

file.remove(c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"))
t2<-system.time(subsetbam(inputbam = bigbam2, outputbams = c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"), tags = list(mid, ext), cores=8, split_bam = T))
cb_check<-peekbam("/Users/sfurlan/Desktop/middle.bam", n = 614127)
all(cb_check %in% mid)
all(mid %in% cb_check)
file.remove(c("/Users/sfurlan/Desktop/middle.bam", "/Users/sfurlan/Desktop/extremes.bam"))
...
outputnames<-file.path("/Users/sfurlan/Desktop", paste0(seq(1, length(tags_little_but_many)), "_little.bam"))
t1<-system.time(subsetbam(inputbam = bigbam2, outputbams = outputnames, tags = tags_little_but_many, cores=8))
file.remove(outputnames)
t2<-system.time(subsetbam(inputbam = bigbam2, outputbams = outputnames, tags = tags_little_but_many, split_bam = T, cores=8))
file.remove(outputnames)
t1
t2
```
